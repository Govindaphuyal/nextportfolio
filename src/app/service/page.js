      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="service-card bg-white rounded-lg shadow-lg p-6 text-center">
            ...
            <p className="text-gray-600">Improving your website’s visibility on search engines.</p>
          </div>
          <div className="service-card bg-white rounded-lg shadow-lg p-6 text-center">
            <div className="text-5xl mb-4 transition-transform duration-300 transform hover:scale-110">
              🎨
            ...
            <p className="text-gray-600">Designing eye-catching graphics and visual content.</p>
          </div>
          <div className="service-card bg-white rounded-lg shadow-lg p-6 text-center">
            <div className="text-5xl mb-4 transition-transform duration-300 transform hover:scale-110">
              📈
            ...
            <p className="text-gray-600">Strategies to enhance your online presence and reach.</p>
          </div>
        </div>
      </div>
      </div>
